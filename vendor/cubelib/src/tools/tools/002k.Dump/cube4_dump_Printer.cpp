...
bool
Printer::is_bit_set( bitstring_t& bits, unsigned bitnum ) const
{
...
void
Printer::__dump_cnode( Cnode* cnode, int level, bitstring_t childrenmarkers ) const
{
    string indent = "";
    for ( int i = 0; i < level; ++i )
    {
...
{
    __dump_cnode( cnode, level, childrenmarkers );
...
{
    __dump_cnode( cnode->get_parent(), 0, childrenmarkers );
