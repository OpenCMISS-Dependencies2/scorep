                           ...
                           KindOfVariable var   )
{
    ...
    switch ( var )
    {
        ...
        case CUBEPL_RESERVED_VARIABLE:
        {
            ...
            {
                reserved_memory.reserve( adress + 20 );
                reserved_memory.resize( adress + 1 );
            }
            if (  reserved_memory[ adress ].size() <= _index )
            {
                reserved_memory[  adress ].reserve( _index + 20 );
        ...
        case  CUBEPL_GLOBAL_VARIABLE:
        {
            ...
            {
                global_memory.reserve( adress + 20 );
                global_memory.resize( adress + 1 );
            }
            if (  global_memory[ adress ].size() <= _index )
            {
                global_memory[  adress ].reserve( _index + 20 );
